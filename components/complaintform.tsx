...
async function createComplaint(payload: CreateComplaintPayload) {
  ...
  if (!response.ok) {
    throw new Error(
      data?.error || data?.message || "Failed to create complaint"
    );
  }
          ...
          <section>
            ...
            >
              ...
              <optgroup label="Water">
                ...
                <option value="Contaminated/Dirty Water">
              ...
              <optgroup label="Electricity">
                ...
                <option value="Electricity Meter Issues">
                  Electricity Meter Issues
                </option>
              </optgroup>

              <optgroup label="Waste Management">
                <option value="Missed Garbage Collection">
              ...
              <optgroup label="Roads & Transport">
                ...
                <option value="Damaged or Collapsed Roads">
                  Damaged or Collapsed Roads
                </option>
                <option value="Missing Road Signs">Missing Road Signs</option>
                <option value="Faulty Traffic Lights">
                  Faulty Traffic Lights
                </option>
                <option value="Poor Stormwater Drainage">
