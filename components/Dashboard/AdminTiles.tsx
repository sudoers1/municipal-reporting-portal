    ...
    return(
        <main className="py-12 flex text-black items-center gap-8 max-sm:flex-col">
            ...
            <section className="bg-white text-2xl w-64 h-fit p-4 flex flex-col justify-center items-center gap-2 rounded-2xl shadow-2xl"> 
                ...
                <button className="bg-brand-secondary px-4 py-1 rounded-lg shadow-sm"><a href="">workers</a></button>
                <button className="bg-brand-secondary/50 px-4 py-1 rounded-md shadow-sm"><a href="">Users</a></button>
                <button className="bg-brand-secondary/50 px-4 py-1 rounded-md shadow-sm"><a href="/admin/verification">workers</a></button>
            </section>
        </main>
    )
}